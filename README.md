...
2. Preprocess the data using scalling and apply Principal Component Analysis for visualization.
3. Train the SGDClassifier using the training data.
4.Predict species for test data and evaluate accuracy with a classification graph. 
...
<img width="938" height="378" alt="image" src="https://github.com/user-attachments/assets/fdeaf0f0-3422-4036-a14c-0e1ad19263e7" />
